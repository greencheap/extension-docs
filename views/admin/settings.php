<?php $view->script('docs-settings', 'docs:app/bundle/admin/docs-settings.js', 'vue') ?>
        ...
        <div class="pk-width-sidebar">
            <div class="uk-panel">
                <ul class="uk-nav uk-nav-default pk-nav-large" uk-switcher="connect: #tab-content">
                    <li><a><i uk-icon="icon:adjust-horizontal-alt;ratio:1.3" class="uk-margin-right"></i> {{ 'General' | trans }}</a></li>
                </ul>
            </div>
        </div>
